<!-- Add New Sales Transaction Information -->
<div class="modal fade" id="addnew" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <center><h4 class="modal-title" id="myModalLabel">Add New Sales Transaction Information</h4></center>
            </div>
			...
			<form method="POST" action="sales_add.php">
                ...
                <div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="timestamp" class="form-control" name="date"  required>
					</div>
				</div>
